# BackgroundErase Elixir CLI

A minimal Elixir script that uploads an image to the BackgroundErase API and saves the returned PNG with transparency. No external dependencies required.
...
```bash
svn export https://github.com/BackgroundErase/api-integrations/trunk/Elixir
cd Elixir
```
...
curl -L -o background_removal.exs \
  https://raw.githubusercontent.com/BackgroundErase/api-integrations/main/Elixir/background_removal.exs
```
...
- POSTs to https://api.backgrounderase.com/v2 with header x-api-key: YOUR_API_KEY.
...
- HTTP 401/403
  - Invalid or expired API key. Check your subscription and key at https://backgrounderase.com/account.
...
- Base URL is fixed to https://api.backgrounderase.com/v2; you shouldn’t need to change it for normal use.
