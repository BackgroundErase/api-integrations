# BackgroundErase JavaScript Client (Node.js)

Minimal Node.js script to remove image backgrounds using the BackgroundErase API. Upload a photo and save the returned PNG (with transparency) locally.
